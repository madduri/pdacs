...
done < /project/projectdirs/hacc/PDACS/Coyote/Grid/$1/$2/$3/params.ini 

numfiles=`ls -l /project/projectdirs/hacc/PDACS/Coyote/Grid/${4}* | wc -l`
...
#linenum=$((linenum + 1))
#echo ${linenum}
#a_val=`sed -n ${linenum}p /project/projectdirs/hacc/PDACS/Coyote/Grid/$1/$2/$3/aout.dat`
...
#done < /project/projectdirs/hacc/PDACS/Coyote/Grid/$1/$2/$3/aout.dat
