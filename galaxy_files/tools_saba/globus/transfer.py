...
#liubo modified, formerly the deadline is fixed to 10, change to user-specified deadline
#    deadline = datetime.utcnow() + timedelta(minutes=10)
    ...
    # update
#liubo added
# use user's deadline to specify timeout, or else timeout is fixed to 120 seconds and GO transfer will turn green after 120 seconds, even the transfer is not completed yet
