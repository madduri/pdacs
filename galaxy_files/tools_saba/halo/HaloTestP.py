...
mpirun -n %(np)d /project/projectdirs/hacc/PDACS/HaloFind_v3/HaloTestP %(inputfile)s
...
#    HaloCatalogFile = options.outputHaloCatalogFile
    ...
    inputArg = "/project/projectdirs/hacc/PDACS/Coyote/Grid/" + snapshotname + "."
    paramFile = options.input
...
#    print red_shift
    cambFile = "/project/projectdirs/hacc/PDACS/Coyote/Grid/" + model + "/" + size + "/" + realization + "/" + "camb" + model + ".tf" 
