    ...
    def setup_external_metadata( self, datasets, sa_session, exec_dir=None, tmp_dir=None, dataset_files_path=None,
        ...
        for dataset in datasets:
            ...
            if not metadata_files:
                ...
                os.chmod(metadata_files.filename_in, 0777)
                ...
                os.chmod(metadata_files.filename_out, 0777)
                ...
                os.chmod(metadata_files.filename_results_code, 0777)
                ...
                os.chmod(metadata_files.filename_kwds, 0777)
                ...
                os.chmod(metadata_files.filename_override_metadata, 0777)
